...
def parsons_html(activity: Activity, order: list[str] | tuple[str, ...]) -> str:
    ...
    for identifier in order:
        ...
        cards.append(
            f'<div class="pykim-parsons-block" draggable="true" data-block-id="{html.escape(identifier)}" '
            'ondragstart="this.parentElement.dataset.drag=this.dataset.blockId" '
            'ondragover="event.preventDefault()" '
            'ondrop="event.preventDefault();window.pykimDropParsons(this)">'
