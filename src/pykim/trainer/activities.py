"""Deklarative interaktive Aufgaben wie Zuordnungen und Parsons-Puzzles."""
...
__all__ = ["Activity", "CodeBlock", "MatchingPair", "activity_from_data", "activity_names", "annotated_code_blocks", "get_activity", "load_activities", "refresh_activities"]
