...
PyKIM 0.11 ist eine kleine Python-Lernumgebung auf Basis von Pyxel. Kim, eine
...
Farbe auswählen, eine Spur beginnen oder beenden und Pixel lesen:
...
Die bisherigen Namen `paint()` und `paint_path()` funktionieren weiterhin als
Aliase für `paint_start()`.
